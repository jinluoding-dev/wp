...
.controller('EvaluateReportCtrl', function($scope, $http) {
...
.controller('ShopInsuranceCtrl', function($scope, $http) {

})

.controller('MeOrderCtrl', function($scope, $http) {
    $scope.doRefresh = function() {
        $scope.$broadcast('scroll.refreshComplete');
    }
})

.controller('MeCouponsCtrl', function($scope, $http) {
    $scope.doRefresh = function() {
        $scope.$broadcast('scroll.refreshComplete');
    }
})

.controller('MeExpressCtrl', function($scope, $http) {

})

.controller('MeExpressOrderCtrl', function($scope, $http) {

})

.controller('MeAccountCtrl', function($scope, $http) {

})

.controller('MeAddressCtrl', function($scope) {
    $scope.division = {
        "北京市": {
